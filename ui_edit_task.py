...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Изменить задачу"))
        self.groupBox.setTitle(_translate("Form", "Изменить задачу"))
        self.label_2.setText(_translate("Form", "Описание задачи"))
